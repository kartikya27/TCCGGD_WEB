                    ...
                    <div class="col-md-7">
                        <div class="why-choosing">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <p class="choosing-details"><b>Global Network:</b> SERMO is the first worldwide
                                ...
                                <li>
                                    <span class="choosing-icon"> <img src="/assets/img/choosing/1.png"
                                            alt="Client Loyalty"></span>
                                    <p class="choosing-details"><b>Full Service Brand Consultancy:</b> Our core
                                ...
                                <li>
                                    <span class="choosing-icon"> <img src="/assets/img/choosing/1.png"
                                            alt="Client Loyalty"></span>
                                    <p class="choosing-details"><b>Brand Loyalty:</b> The building of genuine,
                                ...
                                <li>
                                    ...
                                    <p class="choosing-details"><b>Experienced Team:</b> We leverage the knowledge,
                                ...
                                <li>
                                    ...
                                    <p class="choosing-details"><b>Pan-India Outreach:</b> While we are headquartered in
                                ...
                                <li>
                                    ...
                                    <p class="choosing-details"> <b>Result-Oriented Approach:</b> We design strategies
                                ...
                                <li>
                                    ...
                                    <p class="choosing-details"><b>Digital Marketing: </b> Through creative thinking and
                                ...
                                <li>
                                    ...
                                    <p class="choosing-details"> <b>Social Media:</b> As a one-stop solution for all
                                ...
                                <li>
                                    <span class="choosing-icon"> <img src="/assets/img/choosing/6.png"
                                            alt="Design Expertise"></span>
                                    <p class="choosing-details"> <b>Design Expertise:</b> We help our brands look good
                        ...
                        <div class="all-expertise" style="position:relative;">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>START-UP BUSINESS DEVELOPMENT</p>
                                </li>
                                <li>
                                    <p>AUTOMOTIVE</p>
                                </li>
                        ...
                        <div class="contact-form">
                            ...
                            <form>
                                ...
                                <div style="padding:0px 20px">
                                    <h2 class="mt-20">Get in Touch</h2>
                                    ...
                                    <button type="submit" class="btn__getInTouch btn btn-primary">Let's Connect</button>
